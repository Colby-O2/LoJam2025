...
namespace LJ2025
{
    public class RubiksController : MonoBehaviour
    {
        ...
        [SerializeField, ReadOnly] private bool _isSolved = false;
        ...
        private void OnClickPerformed(InputAction.CallbackContext ctx)
        {
            ...
            if (!VirtualCaster.Instance.Raycast(mousePos, out RaycastHit hit, Mathf.Infinity, ~LayerMask.GetMask("Interactable"))) return;
        ...
        {
            Debug.Log("solved Rubik Cube!");
            _isSolved = true;
            GameManager.GetMonoSystem<IDialogueMonoSystem>().SetFlag("SolvedRubikCube", true);
        }
